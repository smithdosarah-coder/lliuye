...
export const DESK_SECTIONS: DeskSection[] = [
  {
    ...
    meta: "BOOK · 03",
    rows: [
      { ic: "P0", icClass: "dot-p0",   nm: "鼎川精密",       sub: "授信案 · 待终审",       ts: "08:41", href: "/today" },
      { ic: "B",                        nm: "海创智能装备",   sub: "预审 · 材料 7/9",       ts: "昨日",  href: "/today" },
      { ic: "△", icClass: "dot-warn",  nm: "云融科技",       sub: "预警 · 黄色",           ts: "04/15", href: "/warroom" },
    ],
  ...
  },
  {
    ...
    meta: "IN FLIGHT · 04",
    rows: [
      { ic: "报", icClass: "dot-live", nm: "报告助手 · 鼎川精密", sub: "生成中 · 78% · ETA 09:12", ts: "活",    href: "/archive/report" },
      { ic: "预", icClass: "dot-live", nm: "预警助手 · 云融科技", sub: "运行 2:34 · 42%",          ts: "活",    href: "/archive/alert" },
