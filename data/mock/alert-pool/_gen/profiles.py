...
def _counterparties_for(rng, industry_l2: str, city: str) -> list[str]:
    """2-5 个主要对手方 + 残留扩到总 5-8 个"""
    tmpl = {
        "精密机械": ["{}机械设备采购部", "{}重工股份", "{}传动件批发", "{}精工零售"],
        "电子元件": ["{}电子元件批发", "{}集成电路", "{}电子工业园"],
        "模具注塑": ["{}模具科技", "{}塑胶制品", "{}注塑件交易"],
        "家电家居": ["{}家电销售", "{}家居商行", "{}百货连锁"],
        "汽车零部件": ["{}汽车销售集团", "{}汽配城", "{}车用零部件"],
        "纺织服装": ["{}纺织城", "{}服饰连锁", "{}面料供应"],
        "化工材料": ["{}化工贸易", "{}新材料应用", "{}涂料代理"],
        "医疗器械": ["{}医院", "{}医疗投资", "{}医械经销"],
        "金属加工": ["{}五金批发", "{}金属制品", "{}钢贸物流"],
        "食品饮料": ["{}连锁商超", "{}餐饮集团", "{}食品批发"],
        "大宗商品贸易": ["{}能源集团", "{}钢铁进出口", "{}大宗物流"],
        "消费品贸易": ["{}连锁零售", "{}日用品批发", "{}百货商贸"],
        "跨境电商": ["{}跨境物流", "{}海外仓储", "{}电商平台结算"],
        "公路运输": ["{}快递集团", "{}物流中心", "{}货主结算中心"],
        "冷链仓储": ["{}冷链物流", "{}农贸批发市场", "{}连锁商超"],
        "供应链管理": ["{}供应链", "{}分销渠道", "{}电商平台结算"],
        "连锁零售": ["{}批发市场", "{}品牌商总部", "{}便利连锁"],
        "生鲜零售": ["{}农贸市场", "{}生鲜供应链", "{}批发结算"],
        "专业零售": ["{}建材市场", "{}专业批发", "{}连锁分销"],
        "企业服务": ["{}企业客户", "{}工商业集群", "{}园区服务费"],
        "餐饮连锁": ["{}食品供应链", "{}门店加盟结算", "{}餐饮设备"],
        "职业教育": ["{}学员学费归集", "{}培训集团", "{}政府补贴"],
        "商旅酒店": ["{}在线预订平台", "{}连锁酒店集团", "{}商旅企业"],
        "软件信息": ["{}科技客户回款", "{}政企项目回款", "{}SaaS订阅"],
        "SaaS云服务": ["{}云平台订阅", "{}SaaS续费", "{}政企客户"],
        "物联网": ["{}物联模组采购", "{}设备集成商", "{}园区客户"],
        "专业工程": ["{}市政项目方", "{}工程总包", "{}设备采购"],
        "建材供应": ["{}连锁建材", "{}工程项目", "{}经销商批发"],
        "农产品加工": ["{}粮油批发", "{}连锁超市集采", "{}农贸"],
    }
    base = tmpl.get(industry_l2, ["{}客户", "{}贸易公司", "{}工业园"])
