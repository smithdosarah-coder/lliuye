...
(per `_STAGE_DIMENSIONS` payload · /api/credit/presets 路由 batch 4 已下架).
"""
...
def test_stage_dimensions_small_business_grade_threshold_loose():
