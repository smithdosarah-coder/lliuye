...
| 法规 | 关键条款 | 我方对应 |
|---|---|---|
| 《数据安全法》（2021）第 31 条 | 关键信息基础设施重要数据本地化存储 · 出境需安全评估 | §3.1 默认境内 only |
| 《个人信息保护法》（2021）第 38-40 条 | 个人信息出境 4 条件 + 关键 CIIO 出境评估 | §3.2 客户内网部署 + §4 例外流程 |
| 《关键信息基础设施安全保护条例》（2021）第 31 条 | 重要数据 + 个人信息境内存储 | §3.4 数据传输加密 + 物理隔离 |
